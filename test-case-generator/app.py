...
# Model mappings
model_map = {
    "Qwen 1.5B (Fast)": "Qwen/Qwen2-1.5B-Instruct",
    "Phi 1.5B": "microsoft/Phi-3-mini-128k-instruct",
    "Mistral 7B": "mistralai/Mistral-7B-Instruct-v0.2",
}

# Pre-load default model at startup
print("Pre-loading Qwen 1.5B model...")
try:
    generator = TestCaseGenerator(model_name="Qwen/Qwen2-1.5B-Instruct")
    ...
    with gr.Row():
        with gr.Column(scale=2):
            model_choice = gr.Dropdown(
                choices=["Qwen 1.5B (Fast)", "Phi 1.5B", "Mistral 7B"],
                value="Qwen 1.5B (Fast)",
                label="Select Model",
...
if __name__ == "__main__":
    ...
    initialize_model("Qwen 1.5B (Fast)")
